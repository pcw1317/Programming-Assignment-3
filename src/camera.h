...
{
public:
	Camera(glm::vec3 start_pos, glm::vec3 start_dir, glm::vec3 up, glm::mat4 perspective_matrix = glm::mat4()) :
	...
	glm::mat4x4 get_view();
	glm::mat4 get_perspective() { return perspective_matrix_; }
	void set_perspective(const glm::mat4 &persp) { perspective_matrix_ = persp; }
